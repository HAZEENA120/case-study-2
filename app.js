...
mongoose.connect("mongodb+srv://Hazeena:Strong3,.@cluster0.2yh1tlc.mongodb.net/employeeData?retryWrites=true&w=majority")
...
//Task 3: write api with error handling and appropriate api mentioned in the TODO
...
app.post("/api/employeelist", async (req, res) => {
    try {
        ...
        //compare data of postman with schema
